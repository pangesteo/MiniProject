...
<head>
  ...
  <title>Mandiri Utama | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header bg-img">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg">
      <img src="${pageContext.request.contextPath }/resources/dist/img/logox.png" class="user-image" alt="User Image"></span>
    </a>
        ...
        <ul class="nav navbar-nav ">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${pageContext.request.contextPath }/resources/dist/img/adi.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs t-w">Adi Pangestu</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="${pageContext.request.contextPath }/resources/dist/img/adi.jpg" class="img-circle" alt="User Image">

                <p class="text-black">
                  Adi Pangestu - Web Developer
...
<%--          <li><a href="${pageContext.request.contextPath }/admin/master/user"><i class="fa fa-circle-o"></i> User</a></li> --%>
        ...
        <li><a href="${pageContext.request.contextPath }/dashboard"><i class="fa fa-bars "></i> Dashboard</a></li>
        <li><a href="${pageContext.request.contextPath }/asset"><i class="fa fa-circle-o"></i> Asset</a></li>
...
<!--         <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li> -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://adminlte.io">Adi Pangestu-AdminLTE</a>.</strong> All rights
    reserved.
  </footer>
